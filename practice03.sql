...
직원들의 사번 (employee_id), 이름 (first_name), 월급 (salary), 부서명 (department_name),
현재업무 (job_id) 를 사번 (employee_id) 오름차순 으로 정렬하세요
...
나라명, 나라아이디, 도시명, 도시아이디, 부서명, 부서아이디를 나라명 오름차순으로 정렬하여 출력하세요
값이 없는 경우 표시하지 않습니다
(27건)
*/
